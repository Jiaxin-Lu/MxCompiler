...
public class BinaryInst extends IRInstruction
{
    ...
    public BinaryInst(BasicBlock basicBlock, Op op, Operand lhs, Operand rhs, Operand dst)
    {
        super(basicBlock);
        this.op = op;
        this.lhs = lhs;
    ...
    {
        return new BinaryInst(basicBlockMap.getOrDefault(currentBlock, currentBlock), op,
